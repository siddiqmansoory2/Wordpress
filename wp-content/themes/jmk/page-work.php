...
<div class="col-md-3 sidebar">
    ...
    <?php }?> 
            ...
            <div class="ctaside" style="background-image:url(http://jmk.flywheelsites.com/wp-content/uploads/2021/02/ctabg.png)">
        <h3>Get Your Free Remodeling Contractor Quote</h3>
        <p>Looking for a fast, reliable quote? Let us know how we can help, and get a FREE at-home visit and an accurate quote on your project.</p>
        <a class="theme-btn" href="<?php echo get_theme_mod( "mytheme_site-button_link" ); ?>"><?php echo get_theme_mod( "mytheme_site-button_title" ); ?>
		</a>
    </div>    
</div>
