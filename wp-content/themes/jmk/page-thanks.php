...
<script src="https://cdn.jotfor.ms/js/vendor/jquery-1.8.0.min.js?v=3.3.18198" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/js/vendor/maskedinput.min.js?v=3.3.18198" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/js/vendor/jquery.maskedinput.min.js?v=3.3.18198" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/static/prototype.forms.js" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/static/jotform.forms.js?3.3.18198" type="text/javascript"></script>
<script type="text/javascript">
    ...
    (function init(props) {
	  var PREFIX = window.location.href.indexOf('jotform.pro') > -1 || window.location.pathname.indexOf('build') > -1 || window.location.pathname.indexOf('form-templates') > -1 ? '/server.php' : JotForm.server;
	  ...
	  var getFirstAvailableDate = function getFirstAvailableDate(cb) {
	    var _props3 = props,
	    ...
	    var url = PREFIX + '?action=getAppointments&formID=' + formID + '&qid=' + id + '&timezone=' + encodeURIComponent(timezone) + '&ncTz=' + new Date().getTime() + '&firstAvailableDate';

	    return getJSON(url, function (_ref) {
	      var date = _ref.content;
	      return cb(date && typeof date === 'string' ? date : toDateStr(new Date()));
	    });
	  };
	  ...
	  var setTimezone = function setTimezone(timezone) {
	    ...
	    if (input.value) {
	      var date = toDateTimeStr(dz(new Date(input.value), -4, getTimezoneOffset(state.timezone)));
	  ...
	  var effects = function effects() {
	    ...
	    if (!window.CardForm && !window.formBuilderEvents) {
	      // Do not trigger on Card Forms or the v4-editor...
	      window.addEventListener('resize', handleUIUpdate);
	      handleUIUpdate();
	    } else {
	    ...
	    if (window.formBuilderEvents) {
	      // Rarely, this triggers too early and miscalculates available width
	      // due to initial field animation on editor. So we wait until animation is over.
	      setTimeout(function () {
	        window.addEventListener('resize', handleUIUpdate);
	      }, 500);
	    }
	  ...
	  var renderDay = function renderDay() {
	    ...
	    return '\n      <div class=\'appointmentDate\'>\n        ' + dayNames()[day] + ', ' + monthNames()[date.getUTCMonth()] + ' ' + intPrefix(date.getUTCDate()) + '\n      </div>\n    ';
	  };
	  ...
	  loadTimezones(function (data) {
	    ...
	    var timezone = data[cont] && data[cont].find(function (c) {
	      return c.indexOf(city) !== -1;
	    }) && userTimezone || props.timezone.value;

	    setTimezone(timezone);

	    getFirstAvailableDate(function (dateStr) {
	      setDate(dateStr);
	      load();
	    });
	  });
  ...
  if (window.JotForm && JotForm.accessible) $('input_9').setAttribute('tabindex',0);
   ...
   JotForm.prepareCalculationsOnTheFly([null,{"name":"requestAn","qid":"1","text":"Request An Appointment","type":"control_head"},{"name":"submit2","qid":"2","text":"Submit","type":"control_button"},{"description":"","name":"name","qid":"3","text":"Name","type":"control_fullname"},{"description":"","name":"email","qid":"4","subLabel":"example@example.com","text":"Email","type":"control_email"},{"description":"","name":"phoneNumber","qid":"5","text":"Phone Number","type":"control_phone"},{"description":"","name":"appointmentDate","qid":"6","text":"Appointment Date & Time","type":"control_appointment"},{"description":"","name":"projectType","qid":"7","text":"Project Type","type":"control_radio"},null,{"description":"","name":"whatIs","qid":"9","subLabel":"","text":"What is the approximate budget?","type":"control_textbox"},{"description":"","name":"whatIs10","qid":"10","text":"What is the ideal completion date?","type":"control_radio"},{"description":"","name":"areYou11","qid":"11","text":"Are you the homeowner?","type":"control_radio"}]);
   setTimeout(function() {
JotForm.paymentExtrasOnTheFly([null,{"name":"requestAn","qid":"1","text":"Request An Appointment","type":"control_head"},{"name":"submit2","qid":"2","text":"Submit","type":"control_button"},{"description":"","name":"name","qid":"3","text":"Name","type":"control_fullname"},{"description":"","name":"email","qid":"4","subLabel":"example@example.com","text":"Email","type":"control_email"},{"description":"","name":"phoneNumber","qid":"5","text":"Phone Number","type":"control_phone"},{"description":"","name":"appointmentDate","qid":"6","text":"Appointment Date & Time","type":"control_appointment"},{"description":"","name":"projectType","qid":"7","text":"Project Type","type":"control_radio"},null,{"description":"","name":"whatIs","qid":"9","subLabel":"","text":"What is the approximate budget?","type":"control_textbox"},{"description":"","name":"whatIs10","qid":"10","text":"What is the ideal completion date?","type":"control_radio"},{"description":"","name":"areYou11","qid":"11","text":"Are you the homeowner?","type":"control_radio"}]);}, 20); 
</script>
<link href="https://cdn.jotfor.ms/static/formCss.css?3.3.18198" rel="stylesheet" type="text/css" />
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/css/styles/nova.css?3.3.18198" />
<link type="text/css" media="print" rel="stylesheet" href="https://cdn.jotfor.ms/css/printForm.css?3.3.18198" />
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/themes/CSS/566a91c2977cdfcd478b4567.css?"/>
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/css/styles/payment/payment_feature.css?3.3.18198" />
<style type="text/css">
    .form-label-left{
        width:150px;
    }
...
.form-label.form-label-auto { display: block; float: none; text-align: left; width: inherit; } /*PREFERENCES STYLE*/
    ...
    .form-all:before {
      content: "";
      background-image: url("https://www.jotform.com/uploads/Khachanim1/form_files/JMK-2.5ebd4759717137.23219983.png");
...
<form class="jotform-form" action="https://submit.jotform.com/submit/201494324777057/" method="post" name="form_201494324777057" id="201494324777057" accept-charset="utf-8" autocomplete="on">
  <input type="hidden" name="formID" value="201494324777057" />
    ...
    <ul class="form-section page-section">
      ...
      <li class="form-line jf-required" data-type="control_phone" id="id_5">
        ...
        <div id="cid_5" class="form-input-wide jf-required">
          <span class="form-sub-label-container " style="vertical-align:top">
            <input type="tel" id="input_5_full" name="q5_phoneNumber[full]" data-type="mask-number" class="mask-phone-number form-textbox validate[required, Fill Mask]" autoComplete="off" data-masked="true" value="" data-component="phone" aria-labelledby="label_5" required="" />
            <label class="form-sub-label" for="input_5_full" id="sublabel_5_masked" style="min-height:13px" aria-hidden="false">  </label>
          </span>
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_appointment" id="id_6">
        ...
        <div id="cid_6" class="form-input-wide jf-required">
          <div id="input_6" class="appointmentFieldWrapper jfQuestion-fields">
            <input class="appointmentFieldInput validate" name="q6_appointmentDate[date]" id="input_6_date" />
            <input class="appointmentFieldInput" name="q6_appointmentDate[duration]" value="60" id="input_6_duration" />
            <input class="appointmentFieldInput" name="q6_appointmentDate[timezone]" value="America/New_York (GMT-04:00)" id="input_6_timezone" />
      ...
      <li class="form-line" data-type="control_radio" id="id_7">
        <label class="form-label form-label-top form-label-auto" id="label_7" for="input_7"> Project Type </label>
        <div id="cid_7" class="form-input-wide">
          <div class="form-single-column" role="group" aria-labelledby="label_7" data-component="radio">
            <span class="form-radio-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_7_0" name="q7_projectType" value="Handyman Work" />
              <label id="label_input_7_0" for="input_7_0"> Handyman Work </label>
            </span>
            <span class="form-radio-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_7_1" name="q7_projectType" value="Residential Remodeling" />
              <label id="label_input_7_1" for="input_7_1"> Residential Remodeling </label>
            </span>
            <span class="form-radio-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_7_2" name="q7_projectType" value="Commercial Remodeling" />
              <label id="label_input_7_2" for="input_7_2"> Commercial Remodeling </label>
            </span>
            <span class="form-radio-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_7_3" name="q7_projectType" value="New Construction" />
              <label id="label_input_7_3" for="input_7_3"> New Construction </label>
            </span>
            <span class="form-radio-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_7_4" name="q7_projectType" value="Addition" />
              <label id="label_input_7_4" for="input_7_4"> Addition </label>
            </span>
            <span class="form-radio-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_7_5" name="q7_projectType" value="Other" />
              <label id="label_input_7_5" for="input_7_5"> Other </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_9">
        <label class="form-label form-label-top form-label-auto" id="label_9" for="input_9"> What is the approximate budget? </label>
        <div id="cid_9" class="form-input-wide">
          <input type="text" id="input_9" name="q9_whatIs" data-type="input-textbox" class="form-textbox" size="20" value="" data-component="textbox" aria-labelledby="label_9" />
        </div>
      </li>
      <li class="form-line" data-type="control_radio" id="id_10">
        <label class="form-label form-label-top form-label-auto" id="label_10" for="input_10"> What is the ideal completion date? </label>
        <div id="cid_10" class="form-input-wide">
          <div class="form-single-column" role="group" aria-labelledby="label_10" data-component="radio">
            <span class="form-radio-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_10_0" name="q10_whatIs10" value="ASAP" />
              <label id="label_input_10_0" for="input_10_0"> ASAP </label>
            </span>
            <span class="form-radio-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_10_1" name="q10_whatIs10" value="Next 2-3 weeks" />
              <label id="label_input_10_1" for="input_10_1"> Next 2-3 weeks </label>
            </span>
            <span class="form-radio-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_10_2" name="q10_whatIs10" value="Next month" />
              <label id="label_input_10_2" for="input_10_2"> Next month </label>
            </span>
            <span class="form-radio-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_10_3" name="q10_whatIs10" value="Next 2-3 months" />
              <label id="label_input_10_3" for="input_10_3"> Next 2-3 months </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line" data-type="control_radio" id="id_11">
        <label class="form-label form-label-top form-label-auto" id="label_11" for="input_11"> Are you the homeowner? </label>
        <div id="cid_11" class="form-input-wide">
          <div class="form-single-column" role="group" aria-labelledby="label_11" data-component="radio">
            <span class="form-radio-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_11_0" name="q11_areYou11" value="Homeowner" />
              <label id="label_input_11_0" for="input_11_0"> Homeowner </label>
            </span>
            <span class="form-radio-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_11_1" name="q11_areYou11" value="Property Manager" />
              <label id="label_input_11_1" for="input_11_1"> Property Manager </label>
            </span>
            <span class="form-radio-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_11_2" name="q11_areYou11" value="Project Manager" />
              <label id="label_input_11_2" for="input_11_2"> Project Manager </label>
            </span>
            <span class="form-radio-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_11_3" name="q11_areYou11" value="Tenant" />
              <label id="label_input_11_3" for="input_11_3"> Tenant </label>
            </span>
            <span class="form-radio-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_11_4" name="q11_areYou11" value="Other" />
              <label id="label_input_11_4" for="input_11_4"> Other </label>
            </span>
          </div>
        </div>
      </li>
  ...
  <input type="hidden" id="simple_spc" name="simple_spc" value="201494324777057" />
  <script type="text/javascript">
  document.getElementById("si" + "mple" + "_spc").value = "201494324777057-201494324777057";
  </script>
</form>
                    </div>
                </div>
